    ...
    <aside className="fixed right-0 top-0 bottom-0 z-40 w-14 lg:w-16 flex flex-col justify-between items-center py-6 bg-[#12160f]/90 border-l border-[#FFEFD7]/15 backdrop-blur-md select-none">
      ...
      <div className="flex flex-col items-center gap-2">
        <div
          ...
          className="w-10 h-10 rounded-full bg-[#1e251a] border border-[#70F8C1]/50 flex items-center justify-center cursor-pointer shadow-[0_0_12px_rgba(112,248,193,0.3)] hover:scale-105 transition-transform"
          title="Storaboga Sound"
        >
          <DeadlockIcon name="icon_soul" className="w-5 h-5 text-[#70F8C1]" alt="Storaboga Sound" />
        </div>
      ...
      <div className="flex flex-col items-center gap-2">
        {user ? (
          <div className="relative group">
            <button
              onClick={onLogout}
              className="w-10 h-10 rounded-full bg-[#1e251a] border border-[#70F8C1]/40 overflow-hidden cursor-pointer hover:border-[#FF410D] transition-colors"
          ...
          <div className="relative group">
            <button
              onClick={onLogin}
              className="w-10 h-10 rounded-full bg-[#5865F2] hover:bg-[#4752C4] text-white flex items-center justify-center cursor-pointer shadow-lg transition-colors"
