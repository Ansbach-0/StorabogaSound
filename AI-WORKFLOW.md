...
| **Build Agent** | [Google Antigravity CLI](https://antigravity.google) (`agy`) | Design + code: studies references, builds components, screenshots its own work and reviews it before declaring done. Backed by a pool of accounts with quota rotation |
